...
public class MainActivity extends AppCompatActivity {
    ImageView imgMap;
    TextView txtGps;
    private String clientId = "l91ubof6lv";
    private String clientSecret = "ExiPDwuP29vNnbvowGTwQ6xNeB2Vm7YvNxqLgNVC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //로케이션 서비스를 요철하여, 로케이션 매니저 변수에 저장해줘야 한다.
        locationManager = (LocationManager) getSystemService(LOCATION_SERVICE);
        locationListener = new LocationListener() {
            @Override
            public void onLocationChanged(Location location) {
                //안드로이드가, 폰의 위치 바뀔떄마다, 이 메소드를 호출해줍니다.
                //폰의 위치가 바뀔때마다 해주고 싶은 일을 여기에 작성.
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            // 유저가 권한 설정을 하고나면, 처리해야 할 코드를 작성하기 위해서
            // requestCode 값을 설정한다.
